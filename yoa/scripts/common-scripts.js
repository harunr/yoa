...
;(function($){
	$(function(){
        ...
        //this function for moblie nav
        $('.mobile-nav').click(function(){
            $('.main-menu-area').slideToggle();
        });
        
        //this function for body addclass
        if($(".group").length){
            $("body").addClass("group-page-body")
        }
        if($(".direct").length){
            $("body").addClass("direct-page-body")
        }
        
        if($(".broker").length){
            $("body").addClass("broker-page-body")
        }
        
        if($(".consulting").length){
            $("body").addClass("consulting-page-body")
        }
